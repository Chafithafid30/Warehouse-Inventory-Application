    ...
    <div class="collapse navbar-collapse" id="navbar">
        <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
            ...
            <li class="nav-item <?php if(basename($_SERVER['PHP_SELF']) == 'barang.php') echo 'active'; ?>">
                <a class="nav-link" href="barang.php">Barang Masuk <?php if(basename($_SERVER['PHP_SELF']) == 'barang.php') echo '<span class="sr-only">(current)</span>'; ?></a>
            </li>
		    <li class="nav-item">
        ...
        <form class="form-inline" method="POST">
            <div class="form-group mx-2">
                <label class="mr-2">Tanggal Masuk</label>
			...
			<table class="table" style="border-top:#56DE2F 4px solid;">
			  <thead class="thead">
			    <tr>
			      ...
			      <th scope="col">Quantity Barang Masuk</th>
